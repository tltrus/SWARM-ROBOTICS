...
namespace WpfApp.Classes
{
    class Robot
    {
        ...
        private void Rotate(Vector2D target)
        {
            ...
            var after_points = MatrixBase.Mult(before_points, matrixTrans);
        ...
        public void Draw(DrawingContext dc)
        {
            ...
            // Draw labeling
            //FormattedText formattedText = new FormattedText(n.ToString(), CultureInfo.GetCultureInfo("en-us"),
            //                                                FlowDirection.LeftToRight, new Typeface("Verdana"), 8, Brushes.DarkGray,
            //                                                VisualTreeHelper.GetDpi(MainWindow.visual).PixelsPerDip);
            //dc.DrawText(formattedText, new Point(p0.X + 5, p0.Y - 5 - 15));
        }
    }
}
